...
class CustomUserRegistrationForm(UserCreationForm):
    ...
    class Meta:
        ...
        fields = ('username', 'email', 'password1', 'password2', 'user_type', 
                 'phone_number', 'grade_level', 'parent_email', 'terms_accepted')
        ...
        if user_type == 'student':
            ...
            if not parent_email:
                ...
                try:
                    ...
                    self.add_error('parent_email', "Enter a valid parent email address.")
...
class UserProfileForm(forms.ModelForm):
    ...
    def clean_email(self):
        ...
        if email and self.instance:
            ...
            existing_users = CustomUser.objects.filter(email=email).exclude(id=self.instance.id)
