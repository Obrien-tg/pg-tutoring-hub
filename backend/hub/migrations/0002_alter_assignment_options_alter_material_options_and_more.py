    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.FileField(
                ...
                null=True,
                upload_to=hub.models.material_upload_path,
                validators=[
                    hub.models.validate_file_size,
                    django.core.validators.FileExtensionValidator(
                        allowed_extensions=[
        ...
        migrations.AddIndex(
            model_name="assignment",
            index=models.Index(
                fields=["due_date", "is_active"], name="hub_assignm_due_dat_f008d0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="assignment",
            index=models.Index(
                ...
                name="hub_assignm_created_e90e40_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="material",
            index=models.Index(
                fields=["subject", "grade_level"], name="hub_materia_subject_0e9b1d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="material",
            index=models.Index(
                fields=["material_type", "difficulty_level"],
                name="hub_materia_materia_673dd6_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="material",
            index=models.Index(
                ...
                name="hub_materia_is_acti_3260e8_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="studentprogress",
            index=models.Index(
                fields=["student", "status"], name="hub_student_student_209548_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="studentprogress",
            index=models.Index(
                fields=["material", "completed_at"],
                name="hub_student_materia_db6d70_idx",
            ),
        ),
    ]
