    ...
    def handle(self, *args, **options):
        if options["prod_check"]:
            ...
            try:
                ...
                self.stdout.write(
                    "Running deployment check with production settings..."
                )
            ...
            secret_key_status = (
                ...
                if (
                    ...
                    or "django-insecure" in settings.SECRET_KEY
                )
                else "✅ STRONG"
            )
            ...
            if settings.DEBUG:
                ...
                self.stdout.write("To test production readiness:")
                self.stdout.write("1. Set DEBUG=False in .env file")
                self.stdout.write("2. Set security settings to True")
                self.stdout.write("3. Re-run: python manage.py check --deploy")
            else:
                self.stdout.write(
